using Post.Query.Common.Events;
...
{
    public  class EventHandlers: IEventHandler
    {
        private readonly IPostRepository _postRepository;
        private readonly ICommentRepository _commentRepository;

        public EventHandlers(IPostRepository postRepository, ICommentRepository commentRepository)
        {
